...
\begin{figure*}[!htb]
	...
	\vspace{-0.3in}
	\begin{multicols}{1}
		\hspace{4.0in} \includegraphics[width=8cm]{./modelT_p_res_5_k_0/rho_ana_cbhorz.pdf}
	\end{multicols}
	...
	\vspace{-0.3in}
	\begin{multicols}{1}
		\hspace{4.0in} \includegraphics[width=8cm]{./modelT_p_res_5_k_0/v_ana_cbhorz.pdf}
	\end{multicols}
	...
	\vspace{-0.3in}
	\begin{multicols}{1}
		\hspace{4.0in} \includegraphics[width=8cm]{./modelT_p_res_5_k_0/p_ana_cbhorz.pdf}
	\end{multicols}
...
\begin{figure*}[!htb]
		\begin{multicols}{1}
				\hspace{3.0in} \includegraphics[width=17cm]{./Annulus_Thieulot/benchmark_figs/vel_err_conv.pdf}
		\end{multicols}
		
		\begin{multicols}{1}
			\hspace{3.0in} \includegraphics[width=17cm]{./Annulus_Thieulot/benchmark_figs/p_err_conv.pdf}
		\end{multicols}
\end{figure*}
