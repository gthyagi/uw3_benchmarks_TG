...
mesh2 = uw.meshing.StructuredQuadBox(elementRes=(n_els, n_els), minCoords=(0.0, 0.0), maxCoords=(1.0, 1.0), 
...
stokes.bodyforce = sympy.Matrix([0, Piecewise((f_0, x > x_c), (0.0, True))])
